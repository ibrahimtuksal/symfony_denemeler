 ...
 */
class getSSSRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SSSRepository' shared autowired service.
     *
     * @return \App\Repository\SSSRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SSSRepository.php';

        return $container->privates['App\\Repository\\SSSRepository'] = new \App\Repository\SSSRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
