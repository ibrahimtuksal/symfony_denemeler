 ...
 */
class getBolgelerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BolgelerRepository' shared autowired service.
     *
     * @return \App\Repository\BolgelerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BolgelerRepository.php';

        return $container->privates['App\\Repository\\BolgelerRepository'] = new \App\Repository\BolgelerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
