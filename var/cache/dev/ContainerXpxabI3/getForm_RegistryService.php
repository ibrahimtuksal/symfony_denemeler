...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AboutChangeFormType' => ['privates', 'App\\Form\\AboutChangeFormType', 'getAboutChangeFormTypeService', true],
            'App\\Form\\AboutFormType' => ['privates', 'App\\Form\\AboutFormType', 'getAboutFormTypeService', true],
            'App\\Form\\BannerChangeFormType' => ['privates', 'App\\Form\\BannerChangeFormType', 'getBannerChangeFormTypeService', true],
            'App\\Form\\BannerFormType' => ['privates', 'App\\Form\\BannerFormType', 'getBannerFormTypeService', true],
            'App\\Form\\BolgelerFormType' => ['privates', 'App\\Form\\BolgelerFormType', 'getBolgelerFormTypeService', true],
            'App\\Form\\ContentChangeFormType' => ['privates', 'App\\Form\\ContentChangeFormType', 'getContentChangeFormTypeService', true],
            'App\\Form\\ContentFormType' => ['privates', 'App\\Form\\ContentFormType', 'getContentFormTypeService', true],
            'App\\Form\\GeneralFormType' => ['privates', 'App\\Form\\GeneralFormType', 'getGeneralFormTypeService', true],
            'App\\Form\\GeneralInformationChangeFormType' => ['privates', 'App\\Form\\GeneralInformationChangeFormType', 'getGeneralInformationChangeFormTypeService', true],
            'App\\Form\\GeneralInformationFormType' => ['privates', 'App\\Form\\GeneralInformationFormType', 'getGeneralInformationFormTypeService', true],
            'App\\Form\\HizmetlerChangeFormType' => ['privates', 'App\\Form\\HizmetlerChangeFormType', 'getHizmetlerChangeFormTypeService', true],
            'App\\Form\\HizmetlerFormType' => ['privates', 'App\\Form\\HizmetlerFormType', 'getHizmetlerFormTypeService', true],
            'App\\Form\\NumberChangeFormType' => ['privates', 'App\\Form\\NumberChangeFormType', 'getNumberChangeFormTypeService', true],
            'App\\Form\\NumberFormType' => ['privates', 'App\\Form\\NumberFormType', 'getNumberFormTypeService', true],
            'App\\Form\\SSSChangeFormType' => ['privates', 'App\\Form\\SSSChangeFormType', 'getSSSChangeFormTypeService', true],
            'App\\Form\\SSSFormType' => ['privates', 'App\\Form\\SSSFormType', 'getSSSFormTypeService', true],
            ...
            'App\\Form\\AboutChangeFormType' => '?',
            'App\\Form\\AboutFormType' => '?',
            'App\\Form\\BannerChangeFormType' => '?',
            'App\\Form\\BannerFormType' => '?',
            'App\\Form\\BolgelerFormType' => '?',
            'App\\Form\\ContentChangeFormType' => '?',
            'App\\Form\\ContentFormType' => '?',
            'App\\Form\\GeneralFormType' => '?',
            'App\\Form\\GeneralInformationChangeFormType' => '?',
            'App\\Form\\GeneralInformationFormType' => '?',
            'App\\Form\\HizmetlerChangeFormType' => '?',
            'App\\Form\\HizmetlerFormType' => '?',
            'App\\Form\\NumberChangeFormType' => '?',
            'App\\Form\\NumberFormType' => '?',
            'App\\Form\\SSSChangeFormType' => '?',
            'App\\Form\\SSSFormType' => '?',
