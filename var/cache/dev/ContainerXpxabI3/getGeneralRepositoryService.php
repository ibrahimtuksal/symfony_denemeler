 ...
 */
class getGeneralRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GeneralRepository' shared autowired service.
     *
     * @return \App\Repository\GeneralRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GeneralRepository.php';

        return $container->privates['App\\Repository\\GeneralRepository'] = new \App\Repository\GeneralRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
