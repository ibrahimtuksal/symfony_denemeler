...
return [
    ...
    'content_slug' => [['id'], ['_controller' => 'App\\Controller\\Admin\\BolgelerController::slug'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/content/slug']], [], []],
    ...
    'number_home' => [[], ['_controller' => 'App\\Controller\\Admin\\NumberController::index'], [], [['text', '/admin/number']], [], []],
    'number_create' => [[], ['_controller' => 'App\\Controller\\Admin\\NumberController::create'], [], [['text', '/admin/number/create']], [], []],
    'number_update' => [['id'], ['_controller' => 'App\\Controller\\Admin\\NumberController::update'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/number/update']], [], []],
    'number_delete' => [['id'], ['_controller' => 'App\\Controller\\Admin\\NumberController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/number/delete']], [], []],
    'number_operation' => [['id'], ['_controller' => 'App\\Controller\\Admin\\NumberController::operation'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/number/operation']], [], []],
    ...
    'bolgeler_page' => [['slug'], ['_controller' => 'App\\Controller\\PagesController::bolge'], [], [['variable', '/', '[^/]++', 'slug', true], ['text', '/bolge']], [], []],
