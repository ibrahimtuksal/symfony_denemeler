 ...
 */
class getMahalleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MahalleRepository' shared autowired service.
     *
     * @return \App\Repository\MahalleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MahalleRepository.php';

        return $container->privates['App\\Repository\\MahalleRepository'] = new \App\Repository\MahalleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
