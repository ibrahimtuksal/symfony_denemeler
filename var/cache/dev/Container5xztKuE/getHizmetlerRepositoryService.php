 ...
 */
class getHizmetlerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HizmetlerRepository' shared autowired service.
     *
     * @return \App\Repository\HizmetlerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HizmetlerRepository.php';

        return $container->privates['App\\Repository\\HizmetlerRepository'] = new \App\Repository\HizmetlerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
