 ...
 */
class getNumberRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NumberRepository' shared autowired service.
     *
     * @return \App\Repository\NumberRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NumberRepository.php';

        return $container->privates['App\\Repository\\NumberRepository'] = new \App\Repository\NumberRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
